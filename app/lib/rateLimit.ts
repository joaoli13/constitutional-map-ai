...
const DEFAULT_SIMILAR_SEGMENTS_LIMIT = 20;
const DEFAULT_SIMILAR_SEGMENTS_WINDOW_MS = 60_000;
...
export const SIMILAR_SEGMENTS_RATE_LIMIT = createPolicy("similar_segments", {
  limit: DEFAULT_SIMILAR_SEGMENTS_LIMIT,
  windowMs: DEFAULT_SIMILAR_SEGMENTS_WINDOW_MS,
});
